...
from argos_bridge.msg import Haptic, State, Flocking, MultiHaptic
import tf
import signal
...
class Game:
    ...
    def __init__(self, num_bots):
        ...
        self.flock_pub = rospy.Publisher("/swarm/flocking", Flocking, queue_size=1)
        #self.multi_bot_pub = rospy.Publisher("/swarm/haptic", MultiHaptic, queue_size=1)
